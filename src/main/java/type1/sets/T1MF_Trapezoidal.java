 ...
 */
public class T1MF_Trapezoidal extends CIT2_Generator_Prototype
{
    ...
    public T1MF_Trapezoidal(String name, double[] parameters)
    {
        ...
        maxPoints=new Tuple[]{new Tuple(b,c)};
    }   

    
    public T1MF_Trapezoidal clone()
    {
        T1MF_Trapezoidal result= new T1MF_Trapezoidal(name, new double[]{a,b,c,d}, yLevels.clone());
    ...
    {
        CIT2_Generator result= new T1MF_Trapezoidal(name, new double[]{a+shifting_factor, b+shifting_factor, c+shifting_factor, d+shifting_factor});
        if(isLeftShoulder)
        {
