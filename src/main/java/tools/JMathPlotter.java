...
public class JMathPlotter {
    ...
    static public void plotMFs(String name, T1MF_Interface[] sets, Tuple xAxisRange, int discretizationLevel)
    {
        JMathPlotter plotter = new JMathPlotter(17,20,30);
        for (int i=0;i<sets.length;i++)
        {
            plotter.plotMF(name, sets[i], discretizationLevel, xAxisRange, new Tuple(0.0,1.0), false);
        }
        plotter.show(name);
    }
    
    static public void plotMFs(String name, IntervalT2MF_Interface[] sets, int discretizationLevel)
    {
    ...
    public JMathPlotter()
    {
        ...
        axisLightFont = new Font("SansSerif",1,25);
    }
