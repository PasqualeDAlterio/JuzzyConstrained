...
public class ExplainableCentroid {
    ...
    public String printableExplanation()
    {
        ...
        StringBuffer result=new StringBuffer("The leftmost centroid ("+df.format(intervalCentroid.getLeft())+") is obtained from firing the following rules:\n");
        ...
        result.append("\n");
        //Build the explanation for the left endpoint
        result.append("The rightmost centroid ("+df.format(intervalCentroid.getRight())+") is obtained from firing the following rules:\n");
    ...
    public void plotEmbeddedSets()
    {
        ...
        JFreeChartPlotter.plotMFs("Output "+output.getName(), new T1MF_Interface[]{max_es, min_es}, output.getDomain(), 1000);
    }
